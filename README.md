...
-   **Break Free from Bootstrap**: Create dashboards that don’t look
    like every other Shiny app.
...
-   **Flexible Navigation**: With the
    ...
    build fully custom navigation patterns (no standardized layouts like
    in bslib or bs4Dash).
...
with [Quarto](https://quarto.org/) combined
...
-   [muiDataGrid](https://felixluginbuhl.com/muiDataGrid/) -
    Feature-rich data tables with sorting, filtering, and editing
...
`Button()` to capture click events in Shiny. [Read more about input
wrappers](https://appsilon.github.io/shiny.react/articles/shiny-react.html#creating-input-wrappers).

...
#' \item defaultValue `Array<number>| number` \cr Default is - The default value. Use when the component is not controlled.
#' \item disabled `bool` \cr Default is FALSE If true, the component is disabled.
...
#' \item value `Array<number>| number` \cr Default is - The value of the slider. For ranged sliders, provide an array with two values.

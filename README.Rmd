...
The `muiMaterial` R package gives access to the popular [Material UI](https://mui.com/material-ui/getting-started/) React components for Shiny and Quarto. It facilitates:

- The development of [fully customizable](https://felixluginbuhl.com/muiMaterial/articles/dashboard-basic.html) Shiny dashboards.

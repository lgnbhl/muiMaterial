...
The `muiMaterial` R package provides the popular [Material UI](https://mui.com/material-ui/getting-started/) React components for Shiny and R Markdown from the company MUI. It facilitates:

- Creation of [fully customizable](https://felixluginbuhl.com/muiMaterial/articles/dashboard-basic.html) Shiny dashboards.
  - The underlying [UI components](https://felixluginbuhl.com/muiMaterial/articles/) (e.g., cards, buttons, navbars, etc) are also designed to work in other contexts (e.g., in Quarto).
...
- The access of advanced React components from other MUI React libraries:
  - [`muiCharts`](https://felixluginbuhl.com/muiCharts/) provides access to MUI interactive charts.
  - [`muiTreeView`](https://felixluginbuhl.com/muiTreeView/) gives access to customizabe MUI TreeView.
...
This demo is a replica of the [official template](https://mui.com/material-ui/getting-started/templates/dashboard/) created by MUI, the company behind Material UI.

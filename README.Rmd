...
**muiMaterial** gives access to the popular [Material UI](https://mui.com/material-ui/getting-started/) React library from R. 
...
- Create static dashboards using the **[reactRouter](https://felixluginbuhl.com/reactRouter)** R package:
